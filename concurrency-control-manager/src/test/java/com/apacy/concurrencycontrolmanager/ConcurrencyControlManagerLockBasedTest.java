...
class ConcurrencyControlManagerLockBasedTest {
    
    private ConcurrencyControlManagerLockBased manager;
    
    @BeforeEach
    void setUp() {
        manager = new ConcurrencyControlManagerLockBased(new LockManager(), new MockTimestampManager());
    }
